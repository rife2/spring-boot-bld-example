...
public class ApplicationBuild extends WebProject {
    public ApplicationBuild() {
        ...
        scope(compile)
                .include(dependency("org.springframework.boot:spring-boot-starter:3.4.2"))
                .include(dependency("org.springframework.boot:spring-boot-starter-actuator:3.4.2"))
                .include(dependency("org.springframework.boot:spring-boot-starter-web:3.4.2"));
        scope(test)
                .include(dependency("org.springframework.boot:spring-boot-starter-test:3.4.2"))
        ...
        scope(standalone)
                .include(dependency("org.springframework.boot:spring-boot-loader:3.4.2"));
    }
