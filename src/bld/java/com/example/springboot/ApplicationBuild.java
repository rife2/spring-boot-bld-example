...
public class ApplicationBuild extends WebProject {
    public ApplicationBuild() {
        ...
        scope(compile)
                .include(dependency("org.springframework.boot:spring-boot-starter:3.5.1"))
                .include(dependency("org.springframework.boot:spring-boot-starter-actuator:3.5.1"))
                .include(dependency("org.springframework.boot:spring-boot-starter-web:3.5.1"));
        scope(test)
                .include(dependency("org.springframework.boot:spring-boot-starter-test:3.5.1"))
                .include(dependency("org.junit.jupiter:junit-jupiter:5.13.1"))
                .include(dependency("org.junit.platform:junit-platform-console-standalone:1.13.1"))
