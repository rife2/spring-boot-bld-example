...
public class ApplicationBuild extends WebProject {
    public ApplicationBuild() {
        ...
        scope(compile)
                .include(dependency("org.springframework.boot:spring-boot-starter:3.4.6"))
                .include(dependency("org.springframework.boot:spring-boot-starter-actuator:3.4.6"))
                .include(dependency("org.springframework.boot:spring-boot-starter-web:3.4.6"));
        scope(test)
                .include(dependency("org.springframework.boot:spring-boot-starter-test:3.4.6"))
